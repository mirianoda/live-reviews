    ...
    <div>
      ...
      <div className="max-w-3xl mx-auto p-6 text-center my-15">
        ...
        <div className="relative w-full max-w-2xl mx-auto mt-12">
          <div className="flex rounded-full border border-orange-200 bg-white shadow-md overflow-hidden">
            <input
              type="text"
              value={search}
          ...
          {suggestions.length > 0 && (
            <ul className="absolute z-10 w-full bg-white border border-orange-200 rounded-b-xl shadow-md mt-1 max-h-60 overflow-y-auto">
